		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Usage Current Validation",
									"targetURL": "#comsaplhmrzcurrentvalidation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplhmrzcurrentvalidation-display": {
								"semanticObject": "comsaplhmrzcurrentvalidation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lh.mr.zcurrentvalidation",
									"url": sap.ui.require.toUrl("com/sap/lh/mr/zcurrentvalidation")
								}
							}
						}
					}
